...
| F12: convención de título y sistema visual | [~] | Recall y corpus confirman «tema en 3 cucharadas II» y Tokyo Night para IA; títulos ES/EN y cuatro activos 1600x900, 1280x720, 640x360 y 1200x630 integrados | Cerrar build, QA responsive, CI y hashes públicos según el [contrato](avaluos-ii-title-visual-correction-contract.yaml) |
