...
- [x] R2: GitLab and GitHub main at b4638115; pipeline #251 PASS; five public pages and 49 referenced asset hashes match the exact GitLab artifact. Negative control rejects a changed policy body.
