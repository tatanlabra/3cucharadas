...
- [x] LinkedIn entrega la idea y sus límites sin depender del clic: 1.990 caracteres.
- [x] X: mensaje único 242 caracteres ponderados; hilo 232, 249, 253, 245 y 243. Incluye numeración, declaración de IA y enlaces donde corresponden.
...
Los hashes y la versión fuente están en `00-metadata.json`. La revisión editorial local aceptada no sustituye las comprobaciones pendientes de producción y compositor.
