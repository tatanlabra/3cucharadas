...
> **Idea clave**: minimizamos una función objetivo $f(\theta)$ (por ej., $-\mathrm{AUC}$ o $\mathrm{logloss}$) sobre hiperparámetros $\theta$. BO aprende una distribución sobre $f$ y selecciona la próxima $\theta$ maximizando la adquisición.
